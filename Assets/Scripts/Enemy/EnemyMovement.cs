...
public class EnemyMovement : MonoBehaviour
{
    ...
    private EnemySpeed _currentSpeed = EnemySpeed.Idle;
    private float WantedSpeed => _currentSpeed switch
    {
        EnemySpeed.Idle => 0f,
        EnemySpeed.Walk => 0.5f,
        EnemySpeed.Run => 1f,
        _ => 0f
    };
...
public enum EnemySpeed { Idle, Walk, Run }
