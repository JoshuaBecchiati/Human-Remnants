...
public class AnimationTimeLine : MonoBehaviour
{
    ...
    public void ReadyPose() => m_animator.CrossFade("ReadyPose", 0.3f);
    public void CombatPose() => m_animator.CrossFade("CombatPose", 0.3f);
    ...
    public void CombatController() => m_animator.runtimeAnimatorController = m_CombatController;
    public void CinematicController() => m_animator.runtimeAnimatorController = m_CinematicController;
}
